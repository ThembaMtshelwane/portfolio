...
export const projectData = [
  ...
  {
    name: "BookScape",
    techStack: ["TypeScript", "React JS", "Tailwind CSS", "Google Books API"],
    summary:
      "BookScape is a dynamic book discovery and management website designed to enhance the book browsing experience. With a clean and intuitive interface, users can explore the latest book releases, search for specific books, and filter results by genre.",
    responsibilities: [
  ...
  // },
  {
    ...
    summary:
      "This project is a Single Page Application. It is a responsive website built using React and CSS, based on a Figma design. The website emphasizes modern web development practices, utilizing Flexbox and the position property to create a dynamic and responsive layout.",
    responsibilities: ["Responsive web design", "Flexbox Layout"],
  ...
  //   image: `${path}/result-summary-component/result-summary-component.PNG`,
  // },
  // {
  //   name: "FAQ Accordion",
  //   techStack: ["HTML", "CSS"],
